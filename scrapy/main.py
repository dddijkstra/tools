...
from utils.containers import Container, NewContainer
...
def run(pw, p_c):
    ...
    while my_container.current_page_number <= my_container.max_page:
        ...
        try:
            ...
            logging.error(f'第{my_container.current_page_number}加載失敗')
            break
